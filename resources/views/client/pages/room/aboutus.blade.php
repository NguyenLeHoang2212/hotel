        ...
        <div class="container">
            <div class="about">
                            ...
                            <div class="text">
                                ...
                                <div class="gallery">
                                    ...
                                    <div class="owl-slider owl-slider-gallery">
                                        ...
                                        <div class="item" style="background-image:url({{ asset('assets/client/images/slide-2.jpg') }})"></div>

                                        <!-- === slide item === -->

                                        <div class="item" style="background-image:url({{ asset('assets/client/images/room-3.jpg') }})"></div>


                                        <!-- === slide item === -->

                                        <div class="item" style="background-image:url({{ asset('assets/client/images/slide-3.jpg') }})"></div>
                                ...
                                <p>
                                    <img src="{{ asset('assets/client/images/room-2.jpg') }}" alt="Colina Hotel - Resort & accommodation" />
                                </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <article>
                                            ...
                                            <div class="image">
                                                <img src="{{ asset('assets/client/images/user-5.jpg') }}" alt="" />
                                            </div>
                                    ...
                                    <div class="col-sm-3">
                                        <article>
                                            ...
                                            <div class="image">
                                                <img src="{{ asset('assets/client/images/user-4.jpg') }}" alt="" />
                                            </div>
                                            <div class="details details-social">
                                                <div class="inner">
                                    ...
                                    <div class="col-sm-3">
                                        <article>
                                            ...
                                            <div class="image">
                                                <img src="{{ asset('assets/client/images/user-3.jpg') }}" alt="" />
                                            </div>
                                            <div class="details details-social">
                                                <div class="inner">
                                                    <a href="#"><i class="fa fa-facebook"></i></a>
                ...
                <div class="blocks blocks-left">
                    ...
                    <div class="image" style="background-image:url({{ asset('assets/client/images/slide-1.jpg') }})">
                        <img src="{{ asset('assets/client/images/slide-1.jpg') }}" alt="">
                    </div>
                </div>
                ...
                <div class="blocks blocks-right">
                    ...
                    <div class="image" style="background-image:url({{ asset('assets/client/images/services-4.jpg') }})">
