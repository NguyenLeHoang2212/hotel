        ...
        <div class="room-gallery">
            <div class="container">
                <div class="owl-slider owl-theme owl-slider-gallery">
                    ...
                    <div class="item" style="background-image:url({{ asset('assets/client/images/room-4.jpg') }})">
                        <img src="{{ asset('assets/client/images/room-4.jpg') }}" alt="" />
                    </div>

                    <!-- === slide item === -->

                    <div class="item" style="background-image:url({{ asset('assets/client/images/room-2.jpg') }})">
                    ...
                    <div class="item" style="background-image:url({{ asset('assets/client/images/room-1.jpg') }})">
