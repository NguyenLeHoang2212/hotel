            ...
            <div class="row">
                ...
                <div class="col-md-9">
                                ...
                                <div class="owl-slider owl-slider-header">
                                    ...
                                    <div class="item" style="background-image:url({{ asset('assets/client/images/slide-1.jpg') }})">
                                        <div class="box text-center">
                                            ...
                                            <div class="animated" data-animation="slideInRight">
                                                <a href="products-grid" class="btn btn-clean">Virtual tour</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item" style="background-image:url({{ asset('assets/client/images/slide-2.jpg') }})">
                                        <div class="box text-center">
                                            ...
                                            <div class="animated" data-animation="fadeInUp">
                                                <a href="category" class="btn btn-main">Get insipred</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item" style="background-image:url({{ asset('assets/client/images/slide-3.jpg') }})">
                        ...
                        <div class="panel-body">
                            <div class="row buttons">
                                <div class="col-sm-6">
                                    ...
                                    <div class="well" style="background-image:url({{ asset('assets/client/images/room-2.jpg') }})">
                                        <p><button type="button" class="btn btn-main">Main</button></p>
                    ...
                    <div class="panel panel-default" id="breadcrumbs">
                        ...
                        <div class="panel-body">
                            <div class="well" style="background-image:url({{ asset('assets/client/images/activity-1.jpg') }})">
