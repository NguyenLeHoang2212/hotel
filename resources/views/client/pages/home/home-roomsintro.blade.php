...
<section class="rooms rooms-widget rooms-inner">
    ...
    <div class="section-header">
        <div class="container">
            <h2 class="title">Rooms accommodation <a href="rooms-category" class="btn btn-sm btn-clean">View all</a></h2>
...
<section class="stretcher-wrapper">
    ...
    <div class="section-header">
        <div class="container">
            <h2 class="title">Facilities <a href="facility" class="btn btn-sm btn-clean-dark">Explore more</a></h2>
            <p>
