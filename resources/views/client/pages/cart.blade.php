                        ...
                        <tr>
                            ...
                            <th>
                                <a style="color: red" href="#"
                                    class="primary-btn cart-btn cart-btn-right delete-cart"><span></span>
                                    Delete All</a>
                            </th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($carts as $product => $item)
                            <tr id="{{ $product }}">
                                ...
                                <td class="shoping__cart__quantity">
                                    ...
                                    <div class="quantity">
                                        <div data-price="{{ $item['discount_price'] }}"
                                            data-url="{{ route('product.update-item-in-cart', ['product' => $product]) }}"
                                            data-id="{{ $product }}" class="pro-qty">
                                ...
                                <td class="shoping__cart__delete">
                                    <span data-id="{{ $product }}"
                                        data-url="{{ route('product.delete-item-in-cart', ['product' => $product]) }}"
                                        class="icon_close">X</span>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="rowww">
            ...
            <div class="total">
                ...
                <div class="cart__btn-proceed-checkout-dt">
                    <button onclick="location.href='/checkout'" type="button" class="pay btn btn-primary"
                        id="btn-proceed-checkout" title="pay">CHECKOUT</button>
                </div>
            </div>
        </div>
