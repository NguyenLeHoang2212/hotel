...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = DB::table('products')->select('products.*','product_categories.name as product_category_name')->leftjoin('product_categories','products.product_category_id','=','product_categories.id')->orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('client.pages.product.create',['productCategory' => $productCategory]);
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        $message = $check ? "create thành công r bé ơi " : "thất bại" ;
            return redirect()->route('client.product.index')->with('message',$message);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('client.pages.product.detail',['productCategory' => $productCategory,'product' => $product]);    }
    ...
    public function update(UpdateProductRequest $request, string $id)
    {
        ...
        $message = $check ? "update thành công r bé ơi " : "thất bại" ;
            return redirect()->route('client.product.index',['product' => $product])->with('message',$message);
    }
